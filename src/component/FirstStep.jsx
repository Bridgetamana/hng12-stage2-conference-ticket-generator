...
const FirstStep = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Ticket Type:", selectedTicket);
  ...
  return (
    <main className="max-w-[600px] mx-auto">
      <form onSubmit={handleSubmit} className="w-full">
        ...
        <section className="bg-[#08252b] border border-[#0e464f] rounded-[32px] p-4 md:p-6 lg:p-8 mt-8">
          ...
          <section
            className="px-4 md:px-6 py-4 bg-[#23a0b5] rounded-3xl border-l-2 border-r-2 border-b-2 border-[#07363e] backdrop-blur-[14px] my-6 md:my-8 font-roboto"
            style={{
              background:
          ...
          >
            ...
            <div className="p-4 bg-[#042127] rounded-3xl border border-[#07363e] grid grid-cols-1 md:grid-cols-3 gap-3">
              {tickets.map((ticket) => (
                <label
                  key={ticket.id}
                  className={`p-3 rounded-xl border flex flex-col gap-3 hover:cursor-pointer transition-colors ${
                    selectedTicket === ticket.id
                      ? "bg-[#197686] border-[#197686]"
                      : "border-[#07363e] hover:border-[#197686]"
                  }`}
                >
                  <input
                    type="radio"
          ...
          <footer className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            <button
              type="submit"
